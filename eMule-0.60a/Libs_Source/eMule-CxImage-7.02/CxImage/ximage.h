...
/** \addtogroup Painting */ //@{
	...
	int32_t	DrawString(HDC hdc, int32_t x, int32_t y, const wchar_t* text, RGBQUAD color, const wchar_t* font, int32_t lSize = 0, int32_t lWeight = 400, uint8_t bItalic = 0, uint8_t bUnderline = 0, bool bSetAlpha = false);
	// <VATI> extensions
